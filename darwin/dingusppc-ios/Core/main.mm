...
const std::string appDescription = string(
...
std::string getDocumentsDirectory() {
    ...
    const char *utf8String = [documentsDirectory UTF8String];
...
int main2(int argc, char** argv) {
    ...
    string working_directory_path(getDocumentsDirectory());
    
    LOG_F(INFO, "W %s", working_directory_path.c_str());
    ...
    loguru::Verbosity log_verbosity = loguru::Verbosity_9;
